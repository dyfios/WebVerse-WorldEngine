...
{
    /// <summary>
    /// Example script demonstrating how to use terrain stitching feature for TerrainEntity.
    /// This script shows how to create adjacent terrain entities with stitching enabled.
    /// </summary>
    public class TerrainEntityStitchingExample : MonoBehaviour
    {
        ...
        public void CreateTerrainGrid()
        {
            ...
            List<TerrainEntity> createdTerrains = new List<TerrainEntity>();
            ...
            for (int x = 0; x < gridSize; x++)
            {
                for (int z = 0; z < gridSize; z++)
                {
                    ...
                    TerrainEntity terrain = TerrainEntity.Create(
            ...
            if (enableStitching)
            {
                foreach (TerrainEntity terrain in createdTerrains)
                {
        ...
        public void ToggleStitching()
        {
            ...
            foreach (TerrainEntity terrain in allTerrains)
            {
